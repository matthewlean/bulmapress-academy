<?php
/**
 * Template name: Course 8 Day Level 4
 *
...
<section id="newsletter" class="hero is-neon-green">
  <div class="hero-body">
    ...
    <div class="column is-center">
			<div class="field">
				<?php echo do_shortcode( '[contact-form-7 id="166" title="More Info"]' ); ?>
				<p class="control has-icons-left has-icons-right has-addons" style="height: 48px;">
					<input class="input is-small" type="text" style="height: 48px;font-size: 20px;" placeholder="Email Address"><button style="height: 48px;font-size: 20px;" class="button is-white is-inverted is-outlined is-medium">Submit</button>
