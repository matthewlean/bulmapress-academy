			      ...
			      <h2 class="subtitle">
				        "Brush up Course"
						 ...
						 <p class="has-text-white has-text-weight-bold is-size-4 pad-bot-20">
							 The ‘Keytek™ Fitment Course’ is aimed at locksmiths who perhaps wish to brush up on their fitting techniques. This course covers all aspects of lock fitting and encompasses a wide variety of locks.
						</p>
...
<div class="hero-body">
	<div class="container" id="additional">
				<h1 class="m-tb-20">Additional Fitment Course Information</h1>
				<p class="m-tb-20">Throughout the course, students are tutored and assessed on a range of different fitting techniques to use with the most commonly locks encountered on wooden doors including a range of additional security items:</p>
				<h2 class="m-tb-20">Included on the course:</h2>
				<h2 class="m-tb-20">Backsets</h2>
				<p>
					<ul>
				...
				<h2 class="m-tb-20">Mortice Locks</h2>
				<p>
					<ul>
						<li>3 Lever mortice lock</li>
						<li>5 Lever mortice lock</li>
						<li>Insurance Upgrades</li>
						<li>British Standards</li>
					</ul>
				</p>
				<h2 class="m-tb-20">Additional Security</h2>
				<p>
					<ul>
						<li>Key Operated Shootbolts</li>
						<li>Mortice Rack Bolts</li>
						<li>Door Chain</li>
						<li>Door Viewer</li>
