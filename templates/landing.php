			  ...
			  <article class="tile is-child">
			    <div class="All-courses" style="display:flex;justify-content: center;align-items: center;height: 100%;">
			      <div class="content has-text-centered is-size-5">
			        <p class="tile is-child is-medium"><?php the_field('primary-text'); ?></p>
			        <a href="courses/" class="button is-white">
								<svg xmlns="http://www.w3.org/2000/svg" width="auto" height="75px" version="1.2" baseProfile="tiny" viewBox="0 0 554.2 88.7">
